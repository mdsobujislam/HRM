        ...
        public async Task<bool> UpdateEmployee(Employee employee, IFormFile PhotoFile)
        {
            try
            {
                using (var connection = new SqlConnection(_connectionString))
                {
                    ...
                    var queryString = "Update Employees set EmployeeName=EmployeeName,FatherName=@FatherName,MotherName=@MotherName,SpouseName=@SpouseName,DOB=@DOB,Gender=@Gender,BloodGroup=@BloodGroup,MaritalStatus=@MaritalStatus,TinNo=@TinNo,NationalID=@NationalID,Telephone=@Telephone,MobileNo=@MobileNo,MailID=@MailID,PermanentAddress=@PermanentAddress,PresentAddress=@PresentAddress,DateOfAppointment=@DateOfAppointment,Religion=@Religion,Nationality=@Nationality,Shift=@Shift,Version=@Version,JobType=@JobType,UploadPhoto=@UploadPhoto,BranchId=@BranchId,DepartmentId=@DepartmentId,DesignationId=@DesignationId,SubscriptionId=@SubscriptionId,CompanyId=@CompanyId,UpdatedAt=@UpdatedAt where Id='" + branchId + "' ";
                    var parameters = new DynamicParameters();
                    parameters.Add("EmployeeName", employee.EmployeeName, DbType.String);
                    parameters.Add("FatherName", employee.FatherName, DbType.String);
                    parameters.Add("MotherName", employee.MotherName, DbType.String);
                    ...
                    parameters.Add("Version", employee.Version, DbType.String);
                    parameters.Add("JobType", employee.JobType, DbType.String);
                    parameters.Add("UploadPhoto", employee.UploadPhoto, DbType.String);
                    parameters.Add("BranchId", employee.BranchId, DbType.String);
                    parameters.Add("DepartmentId", employee.DepartmentId, DbType.String);
                    parameters.Add("DesignationId", employee.DesignationId, DbType.String);
                    parameters.Add("EmployeeName", employee.EmployeeName, DbType.String);
                    parameters.Add("EmployeeName", employee.EmployeeName, DbType.String);
                    parameters.Add("SubscriptionId", subscriptionId);
                    parameters.Add("CompanyId", companyId);
