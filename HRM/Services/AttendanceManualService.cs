...
{
    public class AttendanceManualService : IAttendanceManualService
    {
        private readonly string _connectionString;
        private readonly BaseService _baseService;

        public AttendanceManualService(IConfiguration configuration, BaseService baseService)
        {
        ...
        public Task<List<AttendanceManual>> GetAllAttendance()
        {
            throw new NotImplementedException();
        }


        public async Task<bool> InsertAttendance(AttendanceManual attendance)
        {
            try
            {
        ...
        public Task<bool> UpdateAttendance(AttendanceManual attendance)
        {
            throw new NotImplementedException();
        }
    }
